    ...
    <div class="modal-dialog">    
      ...
      <div class="modal-content">
        ...
        <div class="form-group">
            ...
            <input type="text" id="telepon_user" name="telepon_user" class="form-control" value="<?php echo $user->telepon_user ?>" required> </div>

        <div class="form-group">
            <label for="text">Email</label>
            <input type="text" id="email_user" name="email_user" class="form-control" value="<?php echo $user->email_user ?>" required> </div>
